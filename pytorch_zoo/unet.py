...
class Unet4(nn.Module):
    def __init__(self, feature_scale=1, num_classes=1, is_deconv=True, num_channels=3,
        ...
        self.down1 = UnetDown(self.num_channels, filters[0], self.is_batchnorm)
...
class UnetConvBlock(nn.Module):
    def __init__(self, in_size, out_size, is_batchnorm, num_layers=2):
        ...
        if is_batchnorm:
            conv = nn.Sequential(nn.Conv2d(int(in_size), out_size, 3, 1, padding=1),
